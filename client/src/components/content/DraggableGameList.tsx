...
import SortableGameItem from "@/components/content/SortableGameItem";
// Import shared type
...
interface DraggableGameListProps {
  games: GameListItem[];
  editMode: boolean;
  gamesToRemove: Set<number>; // Changed from string to number
  onToggleRemoval: (gameId: number) => void; // Changed from string to number
