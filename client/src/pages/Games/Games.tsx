...
const Games = () => {
  ...
  return (
    <>
      <div className="flex flex-row container md:mx-auto px-4 mt-16">
        <h1 className="font-bold text-xl">Upcoming Games</h1>
      </div>

      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 md:mx-auto px-4 container my-16 gap-4 place-items-center join">
        {data.games.map((game) => (
          <Link
